    ...
    <div class="col-md col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Users vs. Day Index</h4>
                ...
                <div class="card-body chartjs">
                    ...
                    <div class="row d-flex justify-content-between">
                        ...
                        <div class="col-md-4 mt-8 p-1">
                            <button type="button" class="btn btn-primery  show-dayindex-table" data-toggle="modal">View
                                Data</button>
                        </div>
                        {{-- <div class="col-md-4">
...
@include('admin.table.usersDayindexTab')

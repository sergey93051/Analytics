...
@section("title","fb Page Reactions");
@push('header')
...
<div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md">
                @include('admin.fcGraph.pageReactions.pageReactionsChart')
            </div>
        </div>
    </div>
</div>
...
<script src="{{asset("assets/js/fcscript/fcReactionsgraph.js")}}"></script>

<script type="text/javascript">
    $(document).ready(function() {
        fcReactions(
            jQuery.parseJSON('<?= "$fcReactionsData" ?>')
        );
    });
</script>
@endpush

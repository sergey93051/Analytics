            ...
            <div class="col-12 col-xl-7">
                <div class="card h-100">
                    <div class="card-header pb-0 p-3">
                        <div class="row">
                            <div class="col-md-8 d-flex align-items-center">
                                <h6 class="mb-0 profile-info-header">Profile Information</h6>
                            </div>
                            @empty(Auth::user()->fb_id || Auth::user()->gl_id)
                            <div class="col-md-4 text-end">
                                <a href="javascript:;" type="button" class="show-editProfile">
                    ...
                    <div class="card-body p-2">
                        ...
                        <small style="color:green;" role="alert">
                            {{ session()->get("success") }}
                        </small>
                        @endif
                        {{-- <p class="text-sm">
                        ...
                        @include('admin.profile.profileInfo')
                        @include('admin.profile.profileForm')
                    </div>
                </div>
            </div>
            {{-- <div class="col-12 col-xl-4">
...
<script>
    $(document).ready(function() {
        profile();
        profileValidation($("#contact_form"));
    });
</script>
@endpush

                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card card-plain mt-3">
                            <div class="card-header pb-0 text-left bg-transparent">
                                {{-- <h4 class="mb-0">Sign in with</h4> --}}
                                <h4 class="mb-0">Sign in</h4>
                            </div>
                            <div class="card-body">
                                <div class="row px-xl-5 px-sm-4 px-3">
                                    {{-- <div class="col-6 ms-auto px-1 text-start">
										<a class="btn btn-outline-light w-100" href="{{route("fcLogin")}}">
                                ...
                                <div class="col-6 me-auto px-1">
                                    <a class="btn btn-outline-light w-100" href="{{route("googleLogin")}}">
                                        <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1"
                                ...
                                <div class="mt-2 position-relative text-center">
                                    {{-- <h4
											class="bg-gray-100 text-sm font-weight-bold mb-2 text-secondary text-border d-inline z-index-2 bg-white px-3">
											or
										</h4> --}}
                                </div>
                            </div>
                            @include('admin.auth.form.loginForm')
                        </div>
